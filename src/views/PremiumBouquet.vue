...
const premiumBouquet = ref(PremiumBouquet.products);
...
const orderViaWA = (product) => {
  const message = `Halo Admin, saya ingin memesan produk Premium Bouquet *${product.category}* kode *${product.code}* `;
  ...
  <div class="bg-beige">
    <section class="py-8 md:py-12 bg-beige px-2 md:px-0">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div
            v-for="product in premiumBouquet"
            :key="product.id"
