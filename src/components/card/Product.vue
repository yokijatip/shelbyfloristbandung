...
<template>
  <div
    ...
    <div class="md:w-full aspect-square overflow-hidden cursor-zoom-in" @click="openZoomModal">
      <img
          :src="imageUrl"
          :alt="category"
          class="w-full h-auto object-center  transition-transform duration-300 hover:scale-105"
      >
    </div>

    <div class="p-4 flex flex-col md:flex-none justify-between">
      <div>
        <h3 class="font-cormorant text-xl font-bold text-darkBeige text-nowrap">{{ category }}</h3>
