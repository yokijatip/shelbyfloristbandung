...
<template>
  <div class="container mx-auto px-4 py-16">
    ...
    <div class="flex flex-col lg:flex-row gap-8">
      ...
      <div class="lg:order-last lg:w-1/3 mb-8 lg:mb-0">
        <div class="lg:pl-8">
          <p class="text-gray-600 uppercase tracking-wider text-sm mb-2">STANDING FLOWER</p>
          <h2 class="text-3xl font-light mb-4">Bunga yang bisa standing dan terbang</h2>
